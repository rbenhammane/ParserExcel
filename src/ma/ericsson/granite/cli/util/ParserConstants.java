...
public class ParserConstants {
	...
	// Global constants
	public static final String ENTITY_MANAGER = "GRANITE";
	public static final String DOMAIN = "INWI";
	public static final String DATASOURCE_EATDS = "EATDS";
	...
	public static final String SQL_QUIT = "quit;";
	
	/** Sic Constants*/
	public static final String SIC_EN = "EN";
	public static final String MENU_SIC_PREFIX = "menu.inwi.gen";
	public static final String FIELD_FORM_SIC_PREFIX = "field.form.inwi.";
	public static final String BUTTON_FORM_SIC_PREFIX = "btn.inwi.sic.";
	...
	public static final String FORM_SIC_PREFIX = "form.inwi.gen.";
