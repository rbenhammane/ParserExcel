...
public abstract class BaseExcelFormSheetParser implements ExcelSheetParser<Sheet, Form> {
	...
	public void setOutput(Form output) {
		this.output = output;
	}
